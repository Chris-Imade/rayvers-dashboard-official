...
const SignUp: React.FC = () => {
  ...
  console.log('password: ', password, 'rePass: ', rePass, 'match: ---->', password === rePass);
    ...
    if (
      ...
      try {
        const response = await fetch(`${BASE_URL}auth/users/`, {
          ...
          body: JSON.stringify({ name, email, password, is_superuser: true }),
        });
          ...
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <Link className="mb-5.5 flex items-center justify-center" to="/">
                ...
                <div>
                  <h2 className="text-white hidden dark:block ml-3 text-xl">
                    Rayvers Kitchen
                  </h2>
                  <h2 className="text-slate-800 dark:hidden ml-3 text-xl">
                    Rayvers Kitchen
                  </h2>
                </div>
              </Link>
              <p className="2xl:px-20">
                Create admin account for Ryvers Kitchen,{' '}
                <span className="text-orange-100">
                  be warned only admins are allowed here, if any malicious
                  activity is detected your account would be suspended!
                </span>
              </p>

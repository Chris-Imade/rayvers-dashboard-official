...
const SignIn: React.FC = () => {
  ...
  return (
    <div className="bg-white shadow-default dark:border-strokedark dark:bg-boxdark h-[100vh]">
        ...
        <div className="hidden w-full xl:block xl:w-1/2">
          <div className="py-17.5 px-26 text-center">
            ...
            <p className="2xl:px-20">
              Sign In as admin
              {'\n'}
              This is the official sign in page for the Rayvers Kitchen -
              Credentials should be kept safe and secure from threats.
            </p>

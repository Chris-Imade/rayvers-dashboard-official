...
import { setAccessToken, setProfile, setUserId, setUserInfo } from '../../Redux/Splice/AppSplice';
    ...
    <div className="relative">
      ...
      >
        ...
        <span className="h-12 w-12 rounded-full">
          <img className="h-12 w-12 rounded-full object-cover" src={profile?.image_url?.length ? profile.image_url : UserOne} alt="User" />
        </span>
